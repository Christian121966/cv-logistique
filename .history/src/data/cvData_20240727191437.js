const cvData = {
    ...
    competences: {
      developpementWeb: [
        "HTML5, CSS3",
        "Utilisation des balises sémantiques avec HTML pour chaque élément d'un site web de réservation de vacances",
        "Apprendre à utiliser des balises sémantiques pour améliorer l'accessibilité et le référencement de votre site web.", 
        "JavaScript (ES6+)",
        "Réalisation d'un carrousel du site d'une imprimerie",
        "Créer un carrousel d'images interactif en utilisant JavaScript.",
        "Utilisation de JavaScript pour créer de manière dynamique le site web d'un architecte",
        "Utiliser JavaScript pour générer du contenu dynamique et interactif sur un site web en communiquant avec une API.",
        "React.js",
        "Responsive design",
        "Implémentation d'un site d'une plateforme de restauration en mobile-first avec SASS",
        "Couvrir les techniques de conception mobile first en utilisant SASS pour garantir un site optimisé pour les appareils mobiles avant de l'adapter aux écrans plus grands. Découvrir comment utiliser les fonctionnalités avancées de SASS comme les variables, les mixins, et les fonctions pour créer des styles modulaires et réutilisables.",
        "Optimisation SEO"
      ],
      logistique: [
